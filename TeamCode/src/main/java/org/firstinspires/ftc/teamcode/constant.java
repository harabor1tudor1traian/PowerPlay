...
public class constant {
    ...
    public static final double verticalCone = 0.0;
    public static final double upsideDownCone = 0.85;
    ...
    public static double chassis_length = 35.6;
    public static int maxVelocityDrivetrain = 300;
